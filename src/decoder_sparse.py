...
class SparseDecoder:
    ...
    def _mode5_iterate_structured_then_peel(
        ...
        *,
        ...
        for it in range(max_iters):
            ...
            stats.sd_calls += 1
            msg_sd, stab_used = structured_decode(msg_work.copy(), self.Hx)
    ...
    def decode(self, msg: np.ndarray, mode: int) -> DecodeResult:
        ...
        stab_msg, stab_used = structured_decode(msg.copy(), self.Hx)
